...
<html lang="en-gb">
    ...
    <body style="background-color:aliceblue;font-family:Verdana;color:darkslategray">    
            ...
            <h1 style="text-align:center;margin-top:30px">ECE Dept.</h1>
         ...
         <div id="link" style="text-align:center;margin-bottom:60px" ><a href="cse.php">Click for Computer Science Department student list</a></div>
    </body>   
</html>
